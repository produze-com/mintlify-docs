...
You can explore these use cases by interacting directly with the agent. Simply share this with 3-4 bullet points outlining your preferences. Here are [prompt examples](https://docs.superfuel.io/more-resources/prompt-examples) for each of these use cases.
...
<Columns cols={3}>
  <Card title="Run your first Workflow" icon="rocket" href="https://docs.superfuel.io/getting-started/first-workflow">
    Follow our 2 step quickstart guide and automate your task
  </Card>
