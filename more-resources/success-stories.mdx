...
3. Ask the Assistant to replicate these exact steps
...
### They treat the Assistant like training a new team member

Their Assistant needs guidance to work their way. Top users:
...
Sellers getting real value have made the Assistant part of their routine:

1. Start their day reviewing Assistant-generated insights
2. Delete workflows that create noise without value
3. Make Assistant insights and recommendations a part of their team meetings
...
4. Explore automation before hiring new team members - can the Assistant handle what a new hire would do?
...
<Columns cols={3}>
  <Card icon="rocket" href="https://docs.superfuel.io/getting-started/first-workflow" title="Run your first Workflow">
  ...
  <Card icon="lightbulb" href="https://docs.superfuel.io/more-resources/popular-usecases" title="Popular use cases">
