...
<Steps>
  <Step title="Navigate to Workflow Library in Workflows section" titleSize="p">
...
<Steps>
  ...
  <Step title="Type in the following prompt in Agent chat">
  ...
  <Step title="Review the Steps proposed by the Agent and make changes if needed. If no changes, ask the Agent to generate the test output.">
  ...
  <Step title="You can Approve the bullet point suggestions to make these changes live on Seller Central (no separate manual action required).">
    
  </Step>
  <Step title="To run the workflow on specific ASINs, select new ASINs to run the workflow on.">
    
  </Step>
  <Step title="To save this workflow for future use, ask the Agent to Save it. To schedule it as recurring task, use the Schedule option.">
    
  </Step>
  <Step title="Once saved, the new Workflow will show up in the Workflows list and any output generated from the Saved workflow will show up in the Output section">
